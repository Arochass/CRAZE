...
},{}],"img/foreground/casual2.png":[function(require,module,exports) {
module.exports = "/casual2.8ecdbd5d.png";
},{}],"img/foreground/minidress.png":[function(require,module,exports) {
module.exports = "/minidress.095bb2a6.png";
},{}],"img/foreground/grunge2.png":[function(require,module,exports) {
module.exports = "/grunge2.7815a092.png";
},{}],"img/foreground/plaid.png":[function(require,module,exports) {
module.exports = "/plaid.e4cd02cb.png";
},{}],"img/foreground/last.png":[function(require,module,exports) {
module.exports = "/last.0a8dd2f9.png";
...
var _casual = _interopRequireDefault(require("/img/foreground/casual2.png"));

var _minidress = _interopRequireDefault(require("/img/foreground/minidress.png"));

var _grunge = _interopRequireDefault(require("/img/foreground/grunge2.png"));

var _plaid = _interopRequireDefault(require("/img/foreground/plaid.png"));

var _last = _interopRequireDefault(require("/img/foreground/last.png"));
...
lscroll.on('scroll', function (args) {
  if (_typeof(args.currentElements['circle']) === 'object') {
    var el = args.currentElements['circle'];
  ...
  if (_typeof(args.currentElements['changeimg']) === 'object') {
    var _el = args.currentElements['changeimg'];
    var _progress = _el.progress;
    var change = document.querySelectorAll('[data-scroll-id="changeimg"]')[0];

    if (_progress >= 0 && _progress < 0.25) {
      change.style.backgroundImage = "url(".concat(_casual.default, ")");
    }

    if (_progress >= 0.25 && _progress < 0.5) {
      change.style.backgroundImage = "url(".concat(_minidress.default, ")");
    }

    if (_progress >= 0.5 && _progress < 0.75) {
      change.style.backgroundImage = "url(".concat(_grunge.default, ")");
    }

    if (_progress >= 0.75 && _progress < 0.9) {
      change.style.backgroundImage = "url(".concat(_plaid.default, ")");
    }

    if (_progress >= 0.9 && _progress < 1) {
      change.style.backgroundImage = "url(".concat(_last.default, ")");
    }
  }
...
},{"../utils":"js/utils.js","../cursor":"js/cursor.js","locomotive-scroll":"../node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js","/img/foreground/casual2.png":"img/foreground/casual2.png","/img/foreground/minidress.png":"img/foreground/minidress.png","/img/foreground/grunge2.png":"img/foreground/grunge2.png","/img/foreground/plaid.png":"img/foreground/plaid.png","/img/foreground/last.png":"img/foreground/last.png"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
